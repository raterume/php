...
if(isset($_GET['name'])){
    ...
    echo '<button class="btn btn-danger" style=" margin:8px; padding: 10px; color: #fff; background-color: #6b9d5c;"><a href="stat.php? name='.$user.'" class="text-light">показать все книги</a></button>';
    ...
    WHERE `stat`.`real_date_ret` = 0000-00-00
    ...
    if($result){
        ...
        echo'<td><button class="btn btn-primary" style=" margin:8px; padding: 10px; color: #fff; background-color: #6b9d5c;"><a href="updatep.php? updateid='.$id.'" class="text-light">Изменить</a></button>
      <button class="btn btn-danger" style=" margin:8px; padding: 10px; color: #fff; background-color: #6b9d5c;"><a href="deleted.php? deleteid='.$id.'" class="text-light">Удалить</a></button>
    </td>';} '</tr>';}}
    ?>
    </tbody>
        </table>
